...
const projects: Project[] = [
  {
    ...
    description:
      "Engineered a custom Model Context Protocol (MCP) server connecting live data endpoints via M2M and OAuth inside a rigid corporate environment. Scaled to 600+ daily active users, unlocking enterprise data silos and earning executive sponsorship for further rollout.",
  ...
  },
  {
    ...
    description:
      "My GenAI sandbox — built solo end-to-end to learn what production-grade agentic AI actually demands. Multi-LLM orchestration (Gemini, OpenAI, Anthropic), deterministic guardrails, eval-driven prompt engineering, server-side tracking, Stripe + DSGVO compliance, Cloudflare-fronted Docker stack on Hetzner. Every layer hand-built, every failure mode logged. The lessons feed directly back into how I architect at scale.",
    tags: [
      "Python",
      "Next.js",
      "FastAPI",
